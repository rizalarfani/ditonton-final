    ...
    return Scaffold(
      body: BlocBuilder<MovieDetailBloc, MovieDetailState>(
        builder: (context, state) {
          if (state is DetailMovieInitial || state is MovieDetailLoading) {
            return Center(
              child: CircularProgressIndicator(),
            );
          } else if (state is DetailMovieHasData) {
            final movie = state.results;
            return SafeArea(
              child: DetailContent(
                  movie,
            ...
            return Center(child: Text('Detail Movie Not Found'));
          } else {
            return Container();
          }
        },
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocBuilder<MoviesRecomendationBloc,
