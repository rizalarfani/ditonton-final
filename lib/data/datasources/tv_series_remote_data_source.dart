...
class TvSeriesRemoteDataSourceImplement extends TvSeriesRemoteDataSource {
  ...
  TvSeriesRemoteDataSourceImplement({required this.ssl});

  @override
  Future<List<TvSeriesModel>> getPopularTvSeries() async {
    Uri url = Uri.parse(BASE_URL + '/tv/popular?$API_KEY');
    Response response = await ssl.fetcData(url);
  ...
  Future<TvSeriesDetailResponse> getDetailTvSeries(int id) async {
    final response = await ssl.fetcData(Uri.parse('$BASE_URL/tv/$id?$API_KEY'));
  ...
  Future<List<TvSeriesModel>> getTvSeriesRecommendations(int id) async {
    final response = await ssl
        .fetcData(Uri.parse('$BASE_URL/tv/$id/recommendations?$API_KEY'));
  ...
  Future<List<TvSeriesModel>> searchTvSeries(String query) async {
    final response = await ssl
        .fetcData(Uri.parse('$BASE_URL/search/tv?$API_KEY&query=$query'));
